/*I've left the cookie creation code off at this point in time (under config) but reformatted and documented as best as I understand it*/ 


function createCookie(e, t, o) {
    var n = ""; if (o) { var i = new Date; i.setTime(i.getTime() + 24 * o * 60 * 60 * 1e3), n = "; expires=" + i.toUTCString() }
